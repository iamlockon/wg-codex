variable "project_id" {
  type        = string
  description = "GCP project ID where the core VM stack will be applied."
}
...
variable "startup_script" {
  type        = string
  description = "Optional GCE startup script override passed through to the core_vm module."
  default     = null
...
variable "create_firewall" {
  type        = bool
  description = "Whether this stack should manage ingress firewall rules for the core VM."
  default     = true
}
