...
- `BOOTSTRAP_GOOGLE_OIDC_CLIENT_ID`, `BOOTSTRAP_GOOGLE_OIDC_CLIENT_SECRET`, and `BOOTSTRAP_GOOGLE_OIDC_REDIRECT_URI` repository secrets for app-login OAuth.
...
6. Save those values as repository secrets:
   - `BOOTSTRAP_GOOGLE_OIDC_CLIENT_ID`
   - `BOOTSTRAP_GOOGLE_OIDC_CLIENT_SECRET`
   - `BOOTSTRAP_GOOGLE_OIDC_REDIRECT_URI`
