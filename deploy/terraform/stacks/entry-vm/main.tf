...
module "entry_vm" {
  ...
  rollout_core_ca_secret_ref          = var.rollout_core_ca_secret_ref
  rollout_core_client_cert_secret_ref = var.rollout_core_client_cert_secret_ref
  rollout_core_client_key_secret_ref  = var.rollout_core_client_key_secret_ref
